        ...
        <div className="bg-zinc-900 rounded-3xl p-6 sm:p-8 lg:p-12 border border-white/10 shadow-lg">
          ...
          <div className="text-gray-400 text-sm sm:text-base leading-relaxed space-y-6">
            ...
            <section>
              ...
              <p>
                By accessing and using ukcasinoss.org (the "Website" or "Service"), you accept and agree
            ...
            <section>
              ...
              <div className="mt-3 bg-white/5 rounded-2xl p-4 border border-white/10">
                ...
                <p>Website: <a href="https://www.ukcasinoss.org" className="text-emerald-400 hover:text-emerald-300 underline">ukcasinoss.org</a></p>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="border-t border-white/10 pt-4 sm:pt-6 text-center">
            <p className="text-gray-500 text-xs sm:text-sm">
              © 2026 ukcasinoss.org. For educational purposes only. 18+ only. Please gamble responsibly.
            </p>
